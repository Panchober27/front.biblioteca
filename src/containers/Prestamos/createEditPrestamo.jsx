...
import { Collapse, Divider, Button, Drawer } from 'antd';
...
const CreateEditPrestamo = () => {
  ...
  // estado para mostrar o no el drawer.
  ...
  const renderDrawer = () => (
    ...
    >
      Este es un Drawer de prueba.
      <br />
      Aqui podemos colocar un formulario, tablas
      <br />
      basciamente cualquier cosa.
      <br />
    </Drawer>
  );
